-- =====================================================
-- CORRECTED INVITATION ACCEPTANCE FIX
-- This fixes the "All object keys must match" error
-- =====================================================

-- Step 1: Check current table structures
SELECT '=== CHECKING CURRENT TABLE STRUCTURES ===' as section;
...
SELECT 'Employees table structure:' as table_info;
SELECT 
    column_name,
    data_type,
    is_nullable,
...
-- Step 2: Add missing columns to employees table if needed
DO $$ 
BEGIN
...
-- Step 3: Drop existing accept_invitation function
...
-- Step 4: Create the corrected accept_invitation function
