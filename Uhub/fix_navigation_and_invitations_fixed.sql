-- =====================================================
-- FIX NAVIGATION AND INVITATION SYSTEM (CORRECTED)
-- =====================================================
-- This script fixes two issues:
-- 1. Navigation problems in admin panel
-- 2. Missing invitation functions
-- 
-- FIXED: Handles reserved keywords properly
...
CREATE TABLE IF NOT EXISTS invitations (
    ...
    "position" VARCHAR(100), -- Quoted reserved keyword
...
RETURNS TABLE (
    ...
    role VARCHAR,
    department VARCHAR,
    "position" VARCHAR, -- Quoted reserved keyword
    status VARCHAR,
...
BEGIN
    ...
    SELECT 
        ...
        i.role,
        i.department,
        i."position", -- Quoted reserved keyword
        i.status,
        i.created_at,
        i.expires_at,
