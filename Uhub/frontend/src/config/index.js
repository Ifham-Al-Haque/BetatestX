...
const config = {
  ...
  roles: {
    ...
    hr_manager: {
      ...
      permissions: ['home', 'calendar_view', 'slice_of_life', 'communication', 'user_profile', 'hr_view', 'it_requests', 'employees', 'attendance', 'hr_operations', 'payroll_calculator', 'epr', 'analytics', 'todo_list'],
    },
    cs_manager: {
      name: 'cs_manager',
