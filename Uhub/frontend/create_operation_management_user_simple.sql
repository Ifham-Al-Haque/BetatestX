-- Simple operation_management user creation
-- This script creates a test user with operation_management role

-- Step 1: Check if user already exists and delete if needed
...
BEGIN
  ...
  IF operation_auth_user_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'Operation Management user created successfully';
  ELSE
