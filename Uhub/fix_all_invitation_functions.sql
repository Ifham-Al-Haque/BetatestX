-- Comprehensive fix for all invitation function conflicts
-- This resolves the "Could not choose the best candidate function" errors

-- 1. Drop ALL existing invitation functions to resolve conflicts
...
-- 2. Create clean, single versions of all functions
...
-- 4. Verify only one version of each function exists
...
SELECT '=== INVITATION FUNCTION CONFLICT RESOLUTION COMPLETE ===' as section;
