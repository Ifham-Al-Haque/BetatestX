-- Quick Fix for IT Requests - Essential Tables Only
-- This script creates the basic tables needed for IT Requests to work immediately
...
-- 9. Create function to generate request number
...
-- 10. Create trigger for request number generation
DROP TRIGGER IF EXISTS trigger_generate_request_number ON it_requests;
...
-- Success message
SELECT 'IT Requests basic setup completed! The system should now work without the view.' as status;
